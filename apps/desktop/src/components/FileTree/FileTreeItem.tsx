...
import { ChevronDown, ChevronRight, FileText, Edit2, Trash2, FolderOpen, Copy, FilePlus, FolderPlus } from 'lucide-react'
import { useTranslation } from 'react-i18next'
import { useFileTreeStore } from '../../stores/fileTree'
import { useTabStore } from '../../stores/tabs'
import { markdownToDoc, setDocLoading } from '../../stores/editor'
import { readFile, addRecentFile, showInFolder } from '../../services'
...
export function FileTreeItem({ node, depth }: FileTreeItemProps) {
  ...
  const { 
    expandedFolders, toggleFolder, selectFile, selectedPath, 
    renamingNode, setRenamingNode, renameNode, deleteNode, createNewItem
  } = useFileTreeStore()
  ...
  }, [node.path, node.isDirectory, toggleFolder, selectFile, addTab, setActiveTab, getTabByFilePath, isRenaming])
      ...
      <div className="file-tree-item-container" onContextMenu={handleContextMenu}>
        ...
        >
          {node.isDirectory ? (
            ...
            <span className="file-tree-icon file-icon"><FileText size={14} /></span>
          )}

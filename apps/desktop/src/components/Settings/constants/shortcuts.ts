...
export const SHORTCUTS: ShortcutCategory[] = [
  // 文件操作
  {
    ...
    shortcuts: [
      { id: 'file-new-window', key: 'Mod-N', descriptionKey: 'settings.shortcuts.actions.newWindow' },
      ...
      { id: 'file-save-as', key: 'Mod-Shift-S', descriptionKey: 'settings.shortcuts.actions.saveAs' },
  ...
  // 编辑操作
  {
    ...
    shortcuts: [
      ...
      { id: 'edit-select-all', key: 'Mod-A', descriptionKey: 'settings.shortcuts.actions.selectAll' },
      { id: 'edit-find', key: 'Mod-F', descriptionKey: 'settings.shortcuts.actions.find' },
      { id: 'edit-replace', key: isMacOS() ? 'Mod-Alt-F' : 'Mod-H', descriptionKey: 'settings.shortcuts.actions.replace' },
  ...
  // 文本格式
  {
    ...
    shortcuts: [
      ...
      { id: 'format-underline', key: 'Mod-U', descriptionKey: 'settings.shortcuts.actions.underline' },
      { id: 'format-strikethrough', key: 'Mod-Shift-S', descriptionKey: 'settings.shortcuts.actions.strikethrough' },
  ...
  // 块转换
  {
    ...
    shortcuts: [
      { id: 'block-paragraph', key: 'Mod-Alt-0', descriptionKey: 'settings.shortcuts.actions.paragraph' },
      ...
      { id: 'block-bullet-list', key: 'Mod-Alt-8', descriptionKey: 'settings.shortcuts.actions.bulletList' },
      { id: 'block-number-list', key: 'Mod-Alt-9', descriptionKey: 'settings.shortcuts.actions.numberList' },
      { id: 'block-code', key: 'Mod-Alt-C', descriptionKey: 'settings.shortcuts.actions.codeBlock' },
      { id: 'block-divider', key: 'Mod-Alt-D', descriptionKey: 'settings.shortcuts.actions.divider' },
    ]
  },
  // 文本对齐
  {
    ...
    shortcuts: [
      { id: 'align-left', key: 'Mod-Shift-L', descriptionKey: 'settings.shortcuts.actions.alignLeft' },
      { id: 'align-center', key: 'Mod-Shift-E', descriptionKey: 'settings.shortcuts.actions.alignCenter' },
      { id: 'align-right', key: 'Mod-Shift-R', descriptionKey: 'settings.shortcuts.actions.alignRight' },
    ]
  },
  // 视图操作
  {
    ...
    shortcuts: [
      { id: 'view-toggle-sidebar', key: 'Mod-\\', descriptionKey: 'settings.shortcuts.actions.toggleSidebar' },
      { id: 'view-toggle-source', key: 'Mod-/', descriptionKey: 'settings.shortcuts.actions.toggleSource' },
      ...
      { id: 'view-zoom-reset', key: 'Mod-0', descriptionKey: 'settings.shortcuts.actions.zoomReset' },
      { id: 'view-settings', key: 'Mod-,', descriptionKey: 'settings.shortcuts.actions.openSettings' },
    ]
  },
]

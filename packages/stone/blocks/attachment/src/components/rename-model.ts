import { ConfirmIcon } from '@ink/stone-components/icons';
...
export const RenameModal = ({
  ...
  return html`
    ...
    <div class="ink-attachment-rename-overlay-mask" @click="${abort}"></div>
    <div class="ink-attachment-rename-container">
      <div class="ink-attachment-rename-input-wrapper">
        <input
          ${ref(inputRef)}
          type="text"
          .value=${fileName}

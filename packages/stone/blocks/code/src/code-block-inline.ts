...
import { InlineManagerExtension, InlineSpecExtension } from '@ink/stone-std/inline';
import { html } from 'lit';
import { z } from 'zod';

export const CodeBlockUnitSpecExtension = InlineSpecExtension<InkTextAttributes>({
...
export const CodeBlockInlineManagerExtension = InlineManagerExtension<InkTextAttributes>({

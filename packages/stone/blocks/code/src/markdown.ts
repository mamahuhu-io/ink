import { type CodeBlockModel, CodeBlockSchema, ParagraphBlockModel } from '@ink/stone-model';
...
export const CodeBlockMarkdownExtension = InlineMarkdownExtension<InkTextAttributes>({
  name: 'code-block',
  pattern: /^```([a-zA-Z0-9]*)\s$/,

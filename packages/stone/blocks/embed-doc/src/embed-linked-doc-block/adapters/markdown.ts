import { EmbedLinkedDocBlockSchema, FootNoteReferenceParamsSchema } from '@ink/stone-model';
import {
  AdapterTextUtils,
...
export const EmbedLinkedDocMarkdownAdapterExtension = BlockMarkdownAdapterExtension(

...
export class EmbedLinkedDocBlockComponent extends EmbedBlockComponent<EmbedLinkedDocModel> {
  ...
  private readonly _renderEmbedView = () => {
    ...
    return this.renderEmbed(
      () => html`
        <div
          class="ink-embed-linked-doc-block ${cardClassMap}"
        ...
        >
          <div class="ink-embed-linked-doc-content">
            ...
            ${when(
              ...
              () =>
                when(
                  ...
                  () => html`
                    <div class="ink-embed-linked-doc-content-note default">
                      ${defaultNoteContent}
                    </div>
                  `,
                  () => html`
            ...
            ${isError
              ? html`
                  <div class="ink-embed-linked-doc-card-content-reload">
                    <div
                      class="ink-embed-linked-doc-card-content-reload-button"
                ...
                `
              : html`
                  <div class="ink-embed-linked-doc-content-date">
                    <span>Updated</span>
  ...
  @queryAsync('.ink-embed-linked-doc-content-note.render')

...
export const styles = css`
  ...
  .ink-embed-linked-doc-block.comment-highlighted {
    outline: 2px solid ${unsafeCSSVarV2('block/comment/highlightUnderline')};
  }

  .ink-embed-linked-doc-block.in-canvas {
  ...
  .ink-embed-linked-doc-content-title {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .ink-embed-linked-doc-content-title-icon {
    display: flex;
    width: 16px;
    height: 16px;
  ...
  .ink-embed-linked-doc-content-title-icon img,
  .ink-embed-linked-doc-content-title-icon object,
  .ink-embed-linked-doc-content-title-icon svg {
    width: 16px;
    height: 16px;
    fill: var(--ink-background-primary-color);
  }

  .ink-embed-linked-doc-content-title-text {
    flex-grow: 1;
    position: relative;
    height: 22px;
  ...
  .ink-embed-linked-doc-content-note.alias,
  ...
  .ink-embed-linked-doc-card-content-reload,
  .ink-embed-linked-doc-content-date {
    display: flex;
    height: 20px;
  ...
  .ink-embed-linked-doc-card-content-reload-button {
    display: flex;
    flex-direction: row;
    align-items: center;
    gap: 4px;
  ...
  .ink-embed-linked-doc-card-content-reload-button svg {
    width: 12px;
    height: 12px;
  }
  .ink-embed-linked-doc-card-content-reload-button > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .ink-embed-linked-doc-content-date > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
    word-break: break-all;
  ...
  .ink-embed-linked-doc-banner img,
  .ink-embed-linked-doc-banner object,
  .ink-embed-linked-doc-banner svg {
    width: 204px;
    max-width: 100%;
    height: 102px;
    object-fit: cover;
  ...
  .ink-embed-linked-doc-block.loading {
    .ink-embed-linked-doc-content-date {
      display: none;
    }
  }

  .ink-embed-linked-doc-block:not(.loading):not(.note-empty) {
    .ink-embed-linked-doc-content-note.render {
      display: block;
    }
  ...
  .ink-embed-linked-doc-block:not(.loading):not(.banner-empty) {
    .ink-embed-linked-doc-banner.default {
      display: none;
    }
  }
  ...
  .ink-embed-linked-doc-block:not(.loading).error,
  .ink-embed-linked-doc-block:not(.loading).deleted {
  ...
  .ink-embed-linked-doc-block.horizontalThin {
    .ink-embed-linked-doc-banner {
      height: 66px;
    }
  ...
  .ink-embed-linked-doc-block.list {
    .ink-embed-linked-doc-content {
      width: 100%;
      flex-direction: row;
      align-items: center;
    ...
    .ink-embed-linked-doc-content-note {
  ...
  .ink-embed-linked-doc-block.vertical {
  ...
  .ink-embed-linked-doc-block.cube {
    .ink-embed-linked-doc-content {
      width: 100%;
      flex-direction: column;

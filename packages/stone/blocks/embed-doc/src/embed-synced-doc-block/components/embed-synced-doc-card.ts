...
export class EmbedSyncedDocCard extends WithDisposable(ShadowlessElement) {
      ...
      >
        <div class="ink-embed-synced-doc-card-content">
          ...
          ${showDefaultNoteContent
            ? html`<div class="ink-embed-synced-doc-content-note default">
                ${defaultNoteContent}
              </div>`
            : nothing}
          <div class="ink-embed-synced-doc-content-note render"></div>

          ${error
            ? html`
                <div class="ink-embed-synced-doc-card-content-reload">
                  <div
                    class="ink-embed-synced-doc-card-content-reload-button"
              ...
              `
            : html`
                <div class="ink-embed-synced-doc-card-content-date">
                  <span>Updated</span>
  ...
  @queryAsync('.ink-embed-synced-doc-card-banner.render')
  ...
  @queryAsync('.ink-embed-synced-doc-content-note.render')

...
export const blockStyles = css`
  ...
  ink-embed-synced-doc-block[data-page-mode] {
  ...
  .edgeless-block-portal-embed .ink-embed-synced-doc-container.edgeless {
    display: block;
    padding: 0;
    width: 100%;
    height: calc(${EMBED_CARD_HEIGHT.syncedDoc}px + 36px);
  }
  .edgeless-block-portal-embed .ink-embed-synced-doc-container.surface {
    border: 1px solid var(--ink-border-color);
  }

  ink-embed-synced-doc-block[data-nested-editor],
  ink-embed-edgeless-synced-doc-block[data-nested-editor] {
    .ink-embed-synced-doc-container.page {
  ...
  .ink-embed-synced-doc-container.comment-highlighted {
    outline: 2px solid ${unsafeCSSVarV2('block/comment/highlightUnderline')};
  }
  .ink-embed-synced-doc-container.show-hover-border:hover {
  ...
  .ink-embed-synced-doc-container.edgeless {
    display: block;
    width: 100%;
    height: calc(${EMBED_CARD_HEIGHT.syncedDoc}px + 36px);
  }
  .ink-embed-synced-doc-header-wrapper {
    position: absolute;
    top: 0;
    left: 0;
    height: 34px;
  ...
  .ink-embed-synced-doc-header-wrapper.selected {
    opacity: 1;
    transition: all 0.23s ease;
  }
  .ink-embed-synced-doc-header {
    display: flex;
    align-items: center;
    width: 100%;
    height: 100%;
  ...
  .ink-embed-synced-doc-header svg {
    flex-shrink: 0;
  }
  .ink-embed-synced-doc-icon {
    line-height: 0;
    color: ${unsafeCSSVarV2('icon/primary')};
  }
  .ink-embed-synced-doc-title {
    font-size: 14px;
    font-weight: 600;
    line-height: 22px;
    margin-left: 8px;
  ...
  .ink-embed-synced-doc-editor-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .ink-embed-synced-doc-editor-empty {
    display: flex;
    align-items: center;
    width: 100%;
    height: 100%;
  ...
  .ink-embed-synced-doc-container.surface
    > .ink-embed-synced-doc-editor
    > .ink-embed-synced-doc-editor-empty {
    left: 0;
  ...
  .ink-embed-synced-doc-editor-empty > span {
  ...
  .ink-embed-synced-doc-container > .ink-embed-synced-doc-editor {
    width: 100%;
    height: 100%;
  }

  .ink-embed-synced-doc-editor .ink-page-root-block-container {
    width: 100%;
    max-width: 100%;
  }
...
export const cardStyles = css`
  ...
  .ink-embed-synced-doc-card-content-title {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .ink-embed-synced-doc-card-content-title-icon {
    display: flex;
    width: 16px;
    height: 16px;
    justify-content: center;
  ...
  .ink-embed-synced-doc-card-content-title-icon svg {
    width: 16px;
    height: 16px;
    fill: var(--ink-background-primary-color);
  }

  .ink-embed-synced-doc-card-content-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
  ...
  .ink-embed-synced-doc-content-note.default {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
    white-space: normal;
  ...
  .ink-embed-synced-doc-card-content-date,
  .ink-embed-synced-doc-card-content-reload {
    display: flex;
    flex-grow: 1;
  ...
  .ink-embed-synced-doc-card-content-date > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .ink-embed-synced-doc-card-content-reload-button {
    display: flex;
    flex-direction: row;
    align-items: center;
    gap: 4px;
  ...
  .ink-embed-synced-doc-card-content-reload-button svg {
    width: 12px;
    height: 12px;
  }
  .ink-embed-synced-doc-card-content-reload-button > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
    word-break: break-all;
  ...
  .ink-embed-synced-doc-card-banner img,
  .ink-embed-synced-doc-card-banner object,
  .ink-embed-synced-doc-card-banner svg {
    width: 204px;
    max-width: 100%;
    height: 102px;
    object-fit: cover;
  ...
  .ink-embed-synced-doc-card.loading,
  .ink-embed-synced-doc-card.deleted,
  .ink-embed-synced-doc-card.error {
    .ink-embed-linked-doc-content-note.render {
      display: none;
    }
    .ink-embed-linked-doc-content-note.default {
      display: block;
    }
    .ink-embed-synced-doc-card-banner.render {
      display: none;
    }
    .ink-embed-synced-doc-card-banner.default {
      display: block;
    }
    .ink-embed-synced-doc-card-content-date {
      display: none;
  ...
  .ink-embed-synced-doc-card:not(.loading).deleted,
  ...
  .ink-embed-synced-doc-card.surface:not(.cycle) {
    ...
    .ink-embed-synced-doc-card-content-note {
      margin: 0 auto;
      flex-grow: 0;
    }
  ...
  .ink-embed-synced-doc-edgeless-header-wrapper {
    position: relative;

...
export class ImageBlockPageComponent extends SignalWatcher(
  ...
  static override styles = css`
    ...
    ink-page-image .ink-image-status {
      position: absolute;
      left: 18px;
      bottom: 18px;
    }

    ink-page-image .resizable-img {
      position: relative;
      max-width: 100%;
    }

    ink-page-image .resizable-img img {
      width: 100%;
      height: 100%;
    }

    ink-page-image .comment-highlighted {
...
declare global {
  interface HTMLElementTagNameMap {
    'ink-page-image': ImageBlockPageComponent;
  }
}

import { ParagraphBlockSchema } from '@ink/stone-model';
import {
...
import type { DeltaInsert, NodeProps } from '@ink/stone-store';
            ...
            .openNode(
              {
                ...
                tagName: 'div',
                properties: {
                  className: ['ink-paragraph-block-container'],
                },
                children: [],
              },
              'children',
            ...
            .openNode(
              {
                ...
                tagName: 'div',
                properties: {
                  className: ['ink-block-children-container'],

...
export class TableCell extends SignalWatcher(WithDisposable(ShadowlessElement)) {
        ...
        items: [
          ...
          menu.group({
            items: [
              ...
              menu.action({
                name: t('editor.table.insertRight', 'Insert Right'),
              ...
              menu.action({
                name: t('editor.table.moveLeft', 'Move Left'),
              ...
              menu.action({
                name: t('editor.table.moveRight', 'Move Right'),
          ...
          menu.group({
            items: [
              menu.action({
                name: t('editor.table.duplicate', 'Duplicate'),
              ...
              menu.action({
                name: t('editor.table.clearColumnContents', 'Clear column contents'),
                prefix: CloseIcon(),
                select: () => {
              ...
              menu.action({
                name: t('editor.table.delete', 'Delete'),
                class: {
                  'delete-item': true,
                },
                prefix: DeleteIcon(),
          ...
          menu.group({
            items: [
              menu.action({
                name: t('editor.table.deleteTable', 'Delete entire table'),
                class: {
                  'delete-item': true,
                },
                prefix: DeleteIcon(),
                select: () => {
                  const tableBlock = this.closest('ink-table') as TableBlockComponent;
                  if (tableBlock?.model) {
                    this.dataManager.model.store.deleteBlock(tableBlock.model);
                  }
                },
              }),
            ],
        ...
        items: [
          ...
          menu.group({
            items: [
              ...
              menu.action({
                name: t('editor.table.insertBelow', 'Insert Below'),
              ...
              menu.action({
                name: t('editor.table.moveUp', 'Move Up'),
              ...
              menu.action({
                name: t('editor.table.moveDown', 'Move Down'),
          ...
          menu.group({
            items: [
              ...
              menu.action({
                name: t('editor.table.clearRowContents', 'Clear row contents'),
                prefix: CloseIcon(),
                select: () => {
        ...
        options: {
          items: [
            ...
            menu.group({
              items: [
                menu.action({
                  name: t('editor.table.clearContents', 'Clear contents'),
                  prefix: CloseIcon(),
                  select: () => {
  ...
  tdStyle() {
    ...
    return styleMap({
      backgroundColor,
      textAlign,
      minWidth: `${DefaultColumnWidth}px`,
    });
  }

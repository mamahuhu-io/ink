...
const styles = css`
  .ink-tooltip {
    ...
    border-radius: 4px;
    padding: 6px 12px;
    color: var(--ink-tooltip-text-color);
    background: var(--ink-tooltip);
 ...
 * // Simple usage
 * html`
 * <ink-tooltip>Content</ink-tooltip>
 * `
 * // With placement
 * html`
 * <ink-tooltip tip-position="top">
 *   Content
 * </ink-tooltip>
 * `
 *
 ...
 *   .autoFlip=${true}
 *   .arrow=${true}
 *   .tooltipStyle=${css`:host { z-index: 0; --ink-tooltip: #fff; }`}

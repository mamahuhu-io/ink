...
describe('snapshot to html', () => {
  ...
  <body>
  <div style="width: 70vw; margin: 60px auto;"><!--InkStoneDocTitlePlaceholder-->
  <!--HtmlTemplate-->
  </div>
  </body>
  </html>
  ...
  test('paragraph', async () => {
    ...
    const html = template(
      `<div class="ink-paragraph-block-container"><p>aaa</p><div class="ink-block-children-container" style="padding-left: 26px;"><div class="ink-paragraph-block-container"><p>bbb</p><div class="ink-block-children-container" style="padding-left: 26px;"></div></div><div class="ink-paragraph-block-container"><p>ccc</p><div class="ink-block-children-container" style="padding-left: 26px;"><div class="ink-paragraph-block-container"><p>ddd</p><div class="ink-block-children-container" style="padding-left: 26px;"></div></div><div class="ink-paragraph-block-container"><p>eee</p><div class="ink-block-children-container" style="padding-left: 26px;"></div></div><div class="ink-paragraph-block-container"><p>fff</p><div class="ink-block-children-container" style="padding-left: 26px;"></div></div></div></div><div class="ink-paragraph-block-container"><p>ggg</p><div class="ink-block-children-container" style="padding-left: 26px;"></div></div></div></div><div class="ink-paragraph-block-container"><p>hhh</p><div class="ink-block-children-container" style="padding-left: 26px;"></div></div>`,
    );
  ...
  test('bulleted list', async () => {
    ...
    const html = template(
      `<ul class="bulleted-list"><li class="ink-list-block-container">aaa<ul class="bulleted-list"><li class="ink-list-block-container">bbb<ul class="bulleted-list"><li class="ink-list-block-container">ccc</li></ul></li><li class="ink-list-block-container">ddd</li></ul></li><li class="ink-list-block-container">eee</li></ul>`,
    );
  ...
  test('different list', async () => {
    ...
    const html = template(
      `<ul class="bulleted-list"><li class="ink-list-block-container">aaa</li></ul><ul style="list-style-type: none; padding-inline-start: 18px;" class="todo-list"><li class="ink-list-block-container"><input type="checkbox"><label style="margin-right: 3px;"></label></input>bbb</li></ul><ul class="bulleted-list"><li class="ink-list-block-container">ccc</li></ul>`,
    );
  ...
  test('code inline', async () => {
    ...
    const html = template(
      `<div class="ink-paragraph-block-container"><p>aaa <code>bbb</code> ccc</p><div class="ink-block-children-container" style="padding-left: 26px;"></div></div>`,
    );
  ...
  test('link', async () => {
    ...
    const html = template(
      `<div class="ink-paragraph-block-container"><p>aaa <a href="https://ink.pro/">bbb</a> ccc</p><div class="ink-block-children-container" style="padding-left: 26px;"></div></div>`,
    );
  ...
  test('bold', async () => {
    ...
    const html = template(
      `<div class="ink-paragraph-block-container"><p>aaa<strong>bbb</strong>ccc</p><div class="ink-block-children-container" style="padding-left: 26px;"></div></div>`,
    );
  ...
  test('italic', async () => {
    ...
    const html = template(
      `<div class="ink-paragraph-block-container"><p>aaa<em>bbb</em>ccc</p><div class="ink-block-children-container" style="padding-left: 26px;"></div></div>`,
    );
  ...
  test('image', async () => {
    ...
    const html = template(
      `<figure class="ink-image-block-container"><img src="assets/YXXTjRmLlNyiOUnHb8nAIvUP6V7PAXhwW9F5_tc2LGs=.blob" alt="YXXTjRmLlNyiOUnHb8nAIvUP6V7PAXhwW9F5_tc2LGs=.blob" title="aaa"></figure><div class="ink-paragraph-block-container"><p></p><div class="ink-block-children-container" style="padding-left: 26px;"></div></div>`,
    );
  ...
  describe('embed link block', () => {
    ...
    for (const testCase of embedTestCases) {
      test(testCase.name, async () => {
        ...
        const html = template(
          `<div class="ink-paragraph-block-container"><a href="${testCase.url}">${testCase.title}</a></div>`,
        );

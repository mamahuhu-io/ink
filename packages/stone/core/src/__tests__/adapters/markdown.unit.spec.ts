...
`;
  ...
  test('link', async () => {
    ...
    const markdown = 'aaa [bbb](https://ink.pro/) ccc\n';
  ...
  test('inline link', async () => {
    ...
    const markdown = 'aaa https://ink.pro/  \n';
...
`;
  ...
  test('inline link', async () => {
    const markdown = 'aaa https://ink.pro/ ccc\n';
    const blockSnapshot: BlockSnapshot = {
      type: 'block',
      id: 'matchesReplaceMap[0]',
      flavour: 'ink:note',

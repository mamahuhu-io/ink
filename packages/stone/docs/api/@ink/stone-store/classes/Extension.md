...
Note: We deliberately used a non-block specific example here. In InkStone, the extension
...
- [`BlockService`](../../stone-std/index/classes/BlockService.md)
- [`LifeCycleWatcher`](../../stone-std/index/classes/LifeCycleWatcher.md)

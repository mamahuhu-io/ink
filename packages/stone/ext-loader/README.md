# @ink/stone-ext-loader

InkStone extension loader system, providing a structured way to manage and load extensions in different contexts.
...
```typescript
import { BaseExtensionProvider } from '@ink/stone-ext-loader';
import { z } from 'zod';
...
```typescript
import { StoreExtensionProvider, StoreExtensionManager } from '@ink/stone-ext-loader';
import { z } from 'zod';
...
```typescript
import { ViewExtensionProvider, ViewExtensionManager } from '@ink/stone-ext-loader';
import { z } from 'zod';

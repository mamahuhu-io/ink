...
export const INK_OUTLINE_PANEL = 'ink-outline-panel';
...
export class OutlinePanel extends SignalWatcher(
  ...
  override render() {
    ...
    return html`
      <ink-outline-panel-header></ink-outline-panel-header>
      <ink-outline-panel-body> </ink-outline-panel-body>
      <ink-outline-notice></ink-outline-notice>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [INK_OUTLINE_PANEL]: OutlinePanel;
  }
}

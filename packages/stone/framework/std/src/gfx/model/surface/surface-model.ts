...
import { assertType, type Constructor } from '@ink/stone-global/utils';
import type { Boxed } from '@ink/stone-store';
import { BlockModel, nanoid } from '@ink/stone-store';
 ...
 * Used for text field
 */
export const SURFACE_TEXT_UNIQ_IDENTIFIER = 'ink:surface:text';
/**
 * Used for field that use Y.Map. E.g. group children field
 */
export const SURFACE_YMAP_UNIQ_IDENTIFIER = 'ink:surface:ymap';

...
export type AttributeRenderer<TextAttributes extends BaseTextAttributes = BaseTextAttributes> =
  (props: {
...
export type DeltaEntry<TextAttributes extends BaseTextAttributes = BaseTextAttributes> = [
  delta: DeltaInsert<TextAttributes>,
  range: InlineRange,
];

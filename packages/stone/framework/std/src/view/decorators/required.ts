...
export const PropTypes = {
  ...
  instanceOf: (expectedClass: Constructor) => (value: unknown) => value instanceof expectedClass,
...
export function requiredProperties(propTypes: Record<string, ValidatorFunction>) {

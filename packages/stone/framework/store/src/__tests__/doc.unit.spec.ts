...
test('query', () => {
  ...
  const page = store1.addBlock('ink:page');
  const note = store1.addBlock('ink:note', {}, page);
  const paragraph1 = store1.addBlock('ink:paragraph', {}, note);
  const list1 = store1.addBlock('ink:list' as never, {}, note);
  ...
  const list2 = store1.addBlock('ink:list' as never, {}, note);

...
/**
 * Core store class that manages blocks and their lifecycle in InkStone
 * @remarks
...
export class Store {
   ...
   * @throws {InkStoneError} When store is in readonly mode
   *
   * @category Block CRUD
   */
   ...
   * @throws {InkStoneError} When the block is not found or schema validation fails
   *
   * @category Block CRUD
   */

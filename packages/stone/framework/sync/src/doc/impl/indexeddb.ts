...
export const DEFAULT_DB_NAME = 'ink-local';
...
interface InkStoneBinaryDB extends DBSchema {
  collection: {
    key: string;
...
export function upgradeDB(db: IDBPDatabase<InkStoneBinaryDB>) {
...
export class IndexedDBDocSource implements DocSource {
  ...
  dbPromise: Promise<IDBPDatabase<InkStoneBinaryDB>> | null = null;
  ...
  getDb() {
    if (this.dbPromise === null) {
      this.dbPromise = openDB<InkStoneBinaryDB>(this.dbName, dbVersion, {
        upgrade: upgradeDB,
      });
    }

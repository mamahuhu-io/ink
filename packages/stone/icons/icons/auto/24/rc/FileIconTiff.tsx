...
const FileIconTiffIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      clipRule="evenodd"
    />
    <rect width={16.8} height={9.6} x={0.6} y={10.8} fill="#6E52DF" rx={1.2} />
    <path
      fill="#fff"
      d="M2.759 14.397v-.76h3.583v.76H5.006V18h-.912v-3.603zM7.855 13.636V18h-.922v-4.364zM8.614 18v-4.364h2.89v.761H9.536v1.04h1.775v.76H9.537V18zM12.124 18v-4.364h2.89v.761h-1.967v1.04h1.774v.76h-1.774V18z"
    />
  </svg>
);
export default FileIconTiffIcon;

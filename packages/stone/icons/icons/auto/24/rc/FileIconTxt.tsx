...
const FileIconTxtIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      clipRule="evenodd"
    />
    <rect width={16.2} height={9.6} x={0.6} y={10.8} fill="#1E1B4B" rx={1.2} />
    <path
      fill="#fff"
      d="M2.96 14.397v-.76h3.585v.76H5.209V18h-.912v-3.603zM8 13.636l.88 1.488h.034l.884-1.488h1.042l-1.332 2.182L10.87 18H9.809l-.895-1.49H8.88L7.985 18H6.928l1.366-2.182-1.34-2.182zM11.258 14.397v-.76h3.583v.76h-1.336V18h-.912v-3.603z"
    />
  </svg>
);
export default FileIconTxtIcon;

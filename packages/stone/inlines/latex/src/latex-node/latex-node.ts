...
export class InkLatexNode extends SignalWatcher(
  ...
  static override styles = css`
    ...
    ink-latex-node .error-placeholder {
      display: flex;
      padding: 2px 4px;
  ...
  override render() {
    return html`<span class="ink-latex" data-selected=${this.selected}
  ...
  @property({ attribute: false })
  accessor editor!: InlineEditor<InkTextAttributes>;

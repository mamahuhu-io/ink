...
export const underlineDeltaToMarkdownAdapterMatcher = InlineDeltaToMarkdownAdapterExtension({
  name: 'underline',
...
export const highlightStyleDeltaToMarkdownAdapterMatcher = InlineDeltaToMarkdownAdapterExtension({

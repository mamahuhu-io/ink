...
import { type InlineRootElement, InlineSpecExtension } from '@ink/stone-std/inline';
...
export const BoldInlineSpecExtension = InlineSpecExtension<InkTextAttributes>({
  name: 'bold',
  schema: z.object({
...
export const ItalicInlineSpecExtension = InlineSpecExtension<InkTextAttributes>({
  name: 'italic',
  schema: z.object({
...
export const UnderlineInlineSpecExtension = InlineSpecExtension<InkTextAttributes>({
  name: 'underline',
  schema: z.object({
...
export const StrikeInlineSpecExtension = InlineSpecExtension<InkTextAttributes>({
  name: 'strike',
  schema: z.object({
...
export const CodeInlineSpecExtension = InlineSpecExtension<InkTextAttributes>({
  name: 'inline-code',
  schema: z.object({
...
export const BackgroundInlineSpecExtension = InlineSpecExtension<InkTextAttributes>({
  name: 'background',
  schema: z.object({
...
export const ColorInlineSpecExtension = InlineSpecExtension<InkTextAttributes>({
  name: 'color',
  schema: z.object({

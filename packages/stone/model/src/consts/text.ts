...
export enum FontFamily {
  BebasNeue = 'stone:surface:BebasNeue',
  Inter = 'stone:surface:Inter',
  Kalam = 'stone:surface:Kalam',
  Lora = 'stone:surface:Lora',
  OrelegaOne = 'stone:surface:OrelegaOne',
  Poppins = 'stone:surface:Poppins',
  Satoshi = 'stone:surface:Satoshi',
}

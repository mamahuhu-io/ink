import type { Bound, SerializedXYWH, XYWH } from '@ink/stone-global/gfx';
import { deserializeXYWH } from '@ink/stone-global/gfx';
import { assertType, noop } from '@ink/stone-global/utils';
import type {
  BaseElementProps,
  GfxModel,

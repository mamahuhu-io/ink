...
export class EditPropsStore extends LifeCycleWatcher {
  ...
  private _getStorageKey<T extends StoragePropsKey>(key: T) {
    ...
    switch (key) {
      case 'viewport':
        return 'stone:' + id + ':edgelessViewport';
      case 'presentBlackBackground':
        return 'stone:presentation:blackBackground';
      case 'presentFillScreen':
        return 'stone:presentation:fillScreen';
      case 'presentHideToolbar':
        return 'stone:presentation:hideToolbar';
      case 'presentNoFrameToastShown':
        return 'stone:presentation:noFrameToastShown';
      case 'templateCache':
        return 'stone:' + id + ':templateTool';
      case 'remoteColor':
        return 'stone:remote-color';
      case 'showBidirectional':
        return 'stone:' + id + ':showBidirectional';
      case 'autoHideEmbedHTMLFullScreenToolbar':
        return 'stone:embedHTML:autoHideFullScreenToolbar';
      default:
        return key;
    }
  }

...
export interface InkStoneFlags {
...
export class FeatureFlagService extends StoreExtension {
  ...
  private readonly _flags: Signal<InkStoneFlags> = signal({
  ...
  setFlag(key: keyof InkStoneFlags, value: boolean) {
    this._flags.value = {
      ...this._flags.value,
      [key]: value,
    };
  ...
  getFlag(key: keyof InkStoneFlags) {

...
export function createInkTemplate(
   ...
   *   <ink-page id="page">
   *     <ink-note id="note">
   *       <ink-paragraph id="paragraph-1">Hello, world<anchor /></ink-paragraph>
   *       <ink-paragraph id="paragraph-2">Hello, world<focus /></ink-paragraph>
   *     </ink-note>
   *   </ink-page>
   * `;
   * ```
   */
  function ink(strings: TemplateStringsArray, ...values: any[]) {
...
export const { ink, block } = createInkTemplate();

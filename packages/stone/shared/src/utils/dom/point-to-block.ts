...
// margin-top: calc(var(--ink-paragraph-space) + 24px);
 ...
 * https://github.com/mamahuhu-io/stone/issues/902
 * https://github.com/mamahuhu-io/stone/pull/1121
 */
 ...
 * In Chrome/Safari, `document.elementsFromPoint` does not include `ink-image`.
 */

...
export class InkLinkedDocWidget extends WidgetComponent<RootBlockModel> {
  ...
  private readonly _renderLinkedDocMenu = () => {
    ...
    return html`<ink-mobile-linked-doc-menu
...
declare global {
  interface HTMLElementTagNameMap {
    [INK_LINKED_DOC_WIDGET]: InkLinkedDocWidget;
  }
}

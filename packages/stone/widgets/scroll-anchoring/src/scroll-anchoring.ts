...
export const INK_SCROLL_ANCHORING_WIDGET = 'ink-scroll-anchoring-widget';

export class InkScrollAnchoringWidget extends WidgetComponent {
  ...
  #moveToAnchorInEdgeless(id: string) {
    ...
    if (parentComponent && parentComponent.flavour === 'ink:note') {
